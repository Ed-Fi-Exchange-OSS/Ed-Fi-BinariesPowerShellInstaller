...
function RunBaseEdFiInstallv340($environment, $edfiVersion) {
    ...
    $binaries = @(  
        ...
        @{  name = "SandboxAdmin"; type = "WebApp";
            ...
            environment = "Sandbox";
            url = "https://www.myget.org/F/ed-fi/api/v2/package/EdFi.Ods.SandboxAdmin.Web.EFA/3.4.0";
            iisAuthentication = @{ "anonymousAuthentication" = $true 
                "windowsAuthentication"                      = $false
            }
            connectionStrings = @{
        ...
        @{  name = "Docs"; type = "WebApp";
            ...
            requiredInEnvironments = @("Production", "Staging", "Sandbox")
            url = "https://www.myget.org/F/ed-fi/api/v2/package/EdFi.Ods.SwaggerUI.EFA/3.4.0";
            iisAuthentication = @{ "anonymousAuthentication" = $true 
                "windowsAuthentication"                      = $false
            }
            envAppSettings = @{
